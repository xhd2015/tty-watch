...
- With TTY stdout and non-TTY stdin, SIGINT still detaches watch promptly.
- The remote session remains registered and TCP-reachable.
...
func Assert(t *testing.T, req *Request, resp *Response, err error) {
	...
	if resp.TimedOut {
		t.Fatal("watch did not detach on SIGINT within 3s with non-TTY stdin")
	}
