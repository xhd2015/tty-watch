...
Skips cmd/ and pure test-harness paths under github.com/xhd2015/tty-watch/.
...
MODULE = "github.com/xhd2015/tty-watch/"
...
def main() -> int:
    ...
    for line in path.read_text().splitlines():
        ...
        if MODULE not in file:
            continue
        rel = file.split(MODULE, 1)[1]
        # Thin main and test harness are not product packages for the table.
        if rel.startswith("cmd/") or rel.startswith("ttywatchtest/"):
            continue
